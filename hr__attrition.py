...
Original file is located at
    https://colab.research.google.com/drive/1PB4McEBV8e031SovOWrinA6CG2NfPWDI
"""
...
"""Employees from the Bachelor are more than from master background. Attrition wrt to Bachleor can be seem mmore because they have more and more expectation from the company and it will be interesting to see the reason behind in this dataset
